          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">9 Total Registered</p>
              </div>
            </div>
                ...
                {filteredRecords.map((user) => {
                  ...
                  return (
                    <tr key={user.id} className="border-b border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{user.register_no}</td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{user.programme}</td>
                      <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-400">{user.batch}</td>
                      <td className="px-6 py-4">
