...
copo_map: (syllabus_id?: any) => {
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/copo-matrix`;
    ...
    copo_update: (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/copo-matrix/cell`;
    ...
    accept_map : (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/copo-matrix/cell/accept`;
    ...
    save_draft: (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/copo-matrix/draft`;
    ...
    approve_map : (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/copo-matrix/approve`;
