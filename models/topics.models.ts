...
const topics = {
    units: (syllabus_id?: any) => {
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/units`;
     ...
     unit_detail : (syllabus_id?: any,unit_number?: any) => {
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/topics-workspace?unit_number=${unit_number}`;
    ...
    generate : (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/generate-hierarchy`;
    ...
    save_draft: (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/topics/draft`;
    ...
    approve_topics: (syllabus_id?: any, body?: any) => { 
        let promise = new Promise((resolve, reject) => {
            let url = `syllabi/${syllabus_id}/topics/approve
`;
