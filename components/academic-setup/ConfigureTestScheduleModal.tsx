            ...
            <div className="divide-y divide-gray-100 rounded-2xl border border-gray-100 bg-[#F9FAFB]/60 px-5 text-xs md:text-sm dark:divide-gray-800 dark:border-gray-800 dark:bg-gray-800/40">
              ...
              <div className="grid grid-cols-3 py-3 items-center">
                ...
                <div className="col-span-2 flex items-center gap-2">
                  ...
                  <span className="rounded bg-gray-200 px-2 py-0.5 text-[10px] font-extrabold uppercase text-gray-600 dark:bg-gray-700 dark:text-gray-300">
                    READ-ONLY
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-4 pt-1">
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between text-xs">
                <label className="font-bold text-sm text-gray-900 dark:text-white">
              ...
              <div className="relative">
                <CalendarIcon className="absolute left-3.5 top-3 h-4 w-4 text-gray-400 pointer-events-none z-10" />
                <Flatpickr
                  value={testDateVal}
                  options={{
                    dateFormat: "d/m/Y",
                  }}
                  className="w-full rounded-xl border border-gray-200 bg-gray-50/50 pl-10 pr-10 py-2.5 text-sm font-semibold text-gray-900 shadow-2xs focus:border-color2 focus:bg-white focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white cursor-pointer"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Clock className="absolute left-3.5 top-3 h-4 w-4 text-gray-400 pointer-events-none z-10" />
                  <Flatpickr
                    value={startTimeVal}
                    options={{
                      noCalendar: true,
              ...
              <div className="flex flex-wrap sm:flex-nowrap items-center gap-3">
                ...
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-gray-50/50 pl-10 pr-4 py-2.5 text-sm font-semibold text-gray-900 shadow-2xs focus:border-color2 focus:bg-white focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white"
