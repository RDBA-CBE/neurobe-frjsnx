                          ...
                          <div className="mt-3.5 pt-3 border-t border-gray-100/80 dark:border-gray-800">
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                              {topic.teachingApproaches.map((approach, idx) => (
                                <span
                                  key={idx}
                                  className="rounded-lg bg-[#f5f3ff] px-3 py-1.5 text-xs font-semibold text-gray-800 border border-purple-100/60 dark:bg-purple-950/40 dark:border-purple-900/50 dark:text-purple-300"
                                >
                                  {approach}
                                </span>
                              ))}
