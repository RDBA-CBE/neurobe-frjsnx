  ...
  return (
    <DataTable
      ...
      columns={[
        ...
        { accessor: "l",      title: "L",            render: ({ l }) => <span className="text-gray-600 dark:text-gray-400">{l}</span> },
        { accessor: "t",      title: "T",            render: ({ t }) => <span className="text-gray-600 dark:text-gray-400">{t}</span> },
        { accessor: "p",      title: "P",            render: ({ p }) => <span className="text-gray-600 dark:text-gray-400">{p}</span> },
        ...
        { accessor: "theory", title: "THEORY HOURS", render: ({ theory }) => <span className="text-gray-600 dark:text-gray-400">{theory}</span> },
        { accessor: "lab",    title: "LAB HOURS",    render: ({ lab }) => <span className="text-gray-600 dark:text-gray-400">{lab}</span> },
